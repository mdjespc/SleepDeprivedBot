...
namespace DiscordBot.Modules.Misc
{
    ...
    public class MiscModule : BaseModule
    {
        ...
        public async Task KalekCommandAsync() => await ReplyAsync("If Kalek has a million fans, I am one of them."
        +" If Kalek has 5 fans, I am one of them. If Kalek has one fan, that one is me. If Kalek has no fans, I am no longer alive."
        +" If the world is against Kalek, I am against the world. Till my last breath, I'll love Kalek.");
